    ...
    <S.ProductCardItemContainer data-testid={name}>
      ...
      <S.ProductInfo>
        <div className="content-infos-title">
          ...
          <S.ButtonsAddDel>
            <button data-testid='decrease-button-1' onClick={() => decrementItemQuantity(id)}>-</button>
            <p>{getItemCount(id)}</p>
            <button data-testid='increase-button-1' onClick={() => incrementItemQuantity(id)}>+</button>
          </S.ButtonsAddDel>
